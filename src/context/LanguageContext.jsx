...
const translations = {
  ...
  Deutsch: {
    ...
    "Start Fulfillment": "Erfüllung starten",
    ...
    "Rapid Fulfillment": "Schnelle Erfüllung",
    ...
    "Returns Management": "Retourenerfüllung",
    ...
    "E-Commerce Fulfillment": "E-Commerce-Erfüllung",
    "Seamlessly scale your D2C brand with high-volume, precision-driven order processing. From pick & pack to last-mile — we architect speed.": "Skalieren Sie Ihre D2C-Marke nahtlos mit hochvolumiger, präzisionsgesteuerter Erfüllung. Von Pick & Pack bis zur letzten Meile - wir entwerfen Geschwindigkeit.",
    ...
    "99.9% fulfillment accuracy across all sectors.": "99,9% Erfüllungs-Genauigkeit über alle Sektoren hinweg.",
    ...
    "How does your returns management process work?": "Wie funktioniert Ihr Retourenerfüllungsprozess?",
    ...
    "Since migrating to Parcellino, our order-to-door time in DACH dropped by 40%. Their fulfillment precision is nothing short of Swiss.": "Seit der Umstellung auf Parcellino hat sich unsere Order-to-Door-Zeit in der DACH-Region um 40% verkürzt. Ihre Erfüllungs-Präzision ist einfach schweizerisch.",
    ...
    // Footer
    "Switzerland's premier fulfillment architecture. Precision, speed, and neutrality for local commerce.": "Die führende Logistik-Architektur der Schweiz. Präzision, Geschwindigkeit und Neutralität für den lokalen Handel.",
    ...
    "Batch & Expiry Management": "Chargen- & Verfallsverwaltung",
    ...
    "IOSS & OSS Management": "IOSS- & OSS-Verwaltung",
    ...
    "E-Com Management": "E-Com-Verwaltung",
    ...
    "© 2026 Precision Fulfillment": "© 2026 Präzisions-Logistik",
    ...
    " who has seen and felt the pain in the fulfillment process, and we have a ": " gegründet, die den Schmerz im Erfüllungsprozess selbst erlebt hat, und wir verfolgen eine ",
    "simple vision": "einfache Vision",
    " to make fulfillment ": ", um die Erfüllung ",
