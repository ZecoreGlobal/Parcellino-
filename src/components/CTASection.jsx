          ...
          <div className="flex items-center justify-center">
            <Magnetic>
              <a 
                ...
                className="bg-swiss-red text-white px-10 py-5 font-bold uppercase tracking-widest hover:bg-swiss-dark hover:text-white transition-all flex items-center gap-3.5 group inline-block shadow-xl shadow-swiss-red/20 rounded-sm"
              >
